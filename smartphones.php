...
?>
			...
			<div class="container">
				...
				<div id="responsive-nav">
					...
					<ul class="main-nav nav navbar-nav">
						...
						<li class="active"><a href="smartphones.php">Smartphones</a></li>
		...
		<div id="breadcrumb" class="section">
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-12">
						<h3 class="breadcrumb-header">Smartphones</h3>
		...
		<div class="section">
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-3">
            <?php
              $product_array = $db_handle->runQuery("SELECT * FROM tblproduct WHERE category='smartphone' ORDER BY id ASC");
